...
export const RootLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <>
      <PanelGroup direction={'horizontal'} className="flex h-screen overflow-hidden">
        <Panel className="relative hidden h-screen border-r lg:block mr-0" defaultSize={15} minSize={14} maxSize={16}>
          <nav className="w-full h-full">
            <div className='flex items-center justify-center min-w-full mr-0'>
              <div className="lg:block pt-5">
                <Link href='/'>
                  {theme == "light" ?
                    <img src="/logo-panora-black.png" className='w-24' /> :
                    <img src="/logo-panora-white-hq.png" className='w-24' />
                  }
                </Link>
              </div>
            </div>

            <div className="space-y-4 py-4 pt-10 mr-0">
            ...
            <div className='absolute bottom-0 left-0 w-full cursor-pointer mr-0'>
              <UserNav />
            </div>
          </nav>
